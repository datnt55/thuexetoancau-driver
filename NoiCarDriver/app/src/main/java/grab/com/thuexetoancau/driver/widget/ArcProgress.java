...
public class ArcProgress extends View {
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = CommonUtilities.convertSpToPixel(getResources(), 18);
        min_size = (int) CommonUtilities.dp2px(getResources(), 100);
        default_text_size = CommonUtilities.convertSpToPixel(getResources(), 40);
        default_suffix_text_size = CommonUtilities.convertSpToPixel(getResources(), 15);
        default_suffix_padding = CommonUtilities.dp2px(getResources(), 4);
        default_suffix_text = "";
        default_bottom_text_size = CommonUtilities.convertSpToPixel(getResources(), 10);
        default_stroke_width = CommonUtilities.dp2px(getResources(), 4);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String text = String.valueOf(30-getProgress());
        ...
        if (!TextUtils.isEmpty(getBottomText())) {
            ...
            float bottomTextBaseline = getHeight() - arcBottomHeight - (textPaint.descent() + textPaint.ascent()) / 2 - CommonUtilities.dp2px(getResources(), 10);
