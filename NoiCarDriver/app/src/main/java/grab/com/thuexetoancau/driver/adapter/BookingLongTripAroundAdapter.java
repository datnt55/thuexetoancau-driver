...
public class BookingLongTripAroundAdapter extends RecyclerView.Adapter<BookingLongTripAroundAdapter.ViewHolder> {
    private Context mContext;
    private List<Trip> arrayTrip;
    private OnItemClickListener listener;

    public BookingLongTripAroundAdapter(Context context, ArrayList<Trip> vehicle) {
        mContext = context;
